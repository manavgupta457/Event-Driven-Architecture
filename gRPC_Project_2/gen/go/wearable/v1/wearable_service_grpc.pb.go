...
type WearableService_ConsumeBeatsPerMinuteClient interface {
	...
	Recv() (*ConsumeBeatsPerMinuteResponse, error)
	grpc.ClientStream
}
...
func (x *wearableServiceConsumeBeatsPerMinuteClient) Recv() (*ConsumeBeatsPerMinuteResponse, error) {
...
// All implementations should embed UnimplementedWearableServiceServer
...
// UnimplementedWearableServiceServer should be embedded to have forward compatible implementations.
...
type WearableService_ConsumeBeatsPerMinuteServer interface {
	Send(*ConsumeBeatsPerMinuteResponse) error
...
func (x *wearableServiceConsumeBeatsPerMinuteServer) Send(m *ConsumeBeatsPerMinuteResponse) error {
	return x.ServerStream.SendMsg(m)
}
